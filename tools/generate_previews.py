...
parser.add_argument('site', help='Instance URL, eg. https://cjdg.bui.pm')
parser.add_argument('song_dir', help='Path to songs directory, eg. /srv/cjdg/public/cjdg/songs')
